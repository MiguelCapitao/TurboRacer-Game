package org.codeforall.turboracer.carFactory;

import org.codeforall.turboracer.gridFactory.Grid;
import org.codeforall.turboracer.initGAME.Game;
import org.codeforall.turboracer.initGAME.GameController;
import org.codeforall.turboracer.initGAME.MenuStart;
...
public class PlayerCar implements KeyboardHandler {
    ...
    Picture drunkDriving = new Picture(65, 10, "resources/images/drunkDriving.png");

    public PlayerCar() {
        this.playerCarPicture = new Picture(368, 430, "resources/images/carblue.png");
    }
    ...
    public void moveRight() {
        ...
        if (maxCarX < Grid.getCols() + Grid.PADDINGX) {
    ...
    public void moveDown() {
        ...
        if (maxCarY < Grid.getRows() + Grid.PADDINGY) {
            playerCarPicture.translate(0, playerSpeed);
        }
    }
    ...
    public boolean isColliding(Picture other) {
        if (playerCarPicture.getX() < other.getX() + other.getWidth() &&
            ...
            if (!hasCollided) {
                Music crashSound = new Music("/resources/Musics/crashsong.wav");
                crashSound.play();
                other.delete();
                hp--;
