package org.codeforall.turboracer.gridFactory;
...
public class Grid {
    ...
    private static Picture gameOver = new Picture(10, 0, "resources/images/gameoverfinal.png");
    ...
    public static void initgrid() {
        roadImage = new Picture(10, 0, "resources/images/linha1.png");
        roadImage.draw();
    ...
    public static void alternateImages() {
        switch (whichRoad) {
            case 0:
                roadImage.load("resources/images/linha1.png");
                whichRoad++;
                break;
            case 1:
                roadImage.load("resources/images/linha2.png");
                whichRoad++;
            case 2:
                roadImage.load("resources/images/linha3.png");
                whichRoad = 0;
                break;
