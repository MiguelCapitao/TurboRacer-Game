...
import org.codeforall.turboracer.HighScoreSaver.Controller;
import org.codeforall.turboracer.carFactory.*;
import org.codeforall.turboracer.gridFactory.Grid;
import org.codeforall.turboracer.music.Music;
...
public class Game {
    ...
    Music initialMusic = new Music("/resources/Musics/testesom.wav");
    Music duringGame = new Music("/resources/Musics/duringGameFinal.wav");
    Music policeSong = new Music("/resources/Musics/police.wav");
    Music voiceOne = new Music("/resources/Musics/voz1.wav");
    Music voiceTwo = new Music("/resources/Musics/voz2.wav");
    private Picture threeLifes = new Picture(1073, 10, "resources/images/vida3.png");
    private Picture twoLifes = new Picture(1073, 10, "resources/images/vida2.png");
    private static Picture oneLife = new Picture(1073, 10, "resources/images/vida1.png");
    ...
    public void initializeScoreAndLevel() {
        contador = new Picture(0, 0, "resources/images/contador1.png");
        contador.draw();
        wantedText = new Picture(1070, 40, "resources/images/wantedText.png");
        wantedText.draw();
    ...
    public void updateLevel() {
        if (Game.level <= 5) {
            Picture newStar = new Picture(starX, starY, "resources/images/star.png");
            newStar.draw();
            starX += 18;
            stars.add(newStar);
        } else {
    ...
    public void pickCoin() {
        for (int i = 0; i < elements.size(); i++) {
            if (playerCar.pickCoin(elements.get(i).getCoin())) {
                ...
                if (rnd != 2) {
                    Music coinSound = new Music("/resources/Musics/coin.wav");
                    coinSound.play();
                    updateScore();
                } else {
                    Music drunk = new Music("/resources/Musics/openBottle.wav");
                    drunk.play();
